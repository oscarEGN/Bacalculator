...
function calcul2() {
	...
	let moyenneHG = valeurHG.toFixed(1);
	...
	let moyenneLVA = valeurLVA.toFixed(1);
	...
	let moyenneLVB = valeurLVB.toFixed(1);
	...
	let moyenneES = valeurES.toFixed(1);
	...
	let moyenneSPEP = valeurSPEP.toFixed(1);
	...
	let moyenneEMC = valeurEMC.toFixed(1);
	...
	let moyenneCC = controleCCP.toFixed(1)
	...
	let moyenneHGT = valeurHGT.toFixed(1);
	...
	let moyenneLVAT = valeurLVAT.toFixed(1);
	...
	let moyenneLVBT = valeurLVBT.toFixed(1);
	...
	let moyenneEST = valeurEST.toFixed(1);
	...
	let moyenneEPST = valeurEPST.toFixed(1);
	...
	let moyenneEMCT = valeurEMCT.toFixed(1);
	...
	let moyenneCCT = controleCCT.toFixed(1);
...
btn.addEventListener('click', calcul1);
calcule.addEventListener('click', calcul2);
